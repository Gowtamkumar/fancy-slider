...
//Enter keyboard evetn
var searchFiled = document.getElementById("search").addEventListener("keypress", function (event) {
  if (event.key == 'Enter') {
...
const createSlider = () => {
  ...
  const durationValidation = document.getElementById('duration').value;
  console.log(durationValidation);

  if (durationValidation > 0) {
  ...
  `;
    ...
    alert('Please positive value input');
  }
